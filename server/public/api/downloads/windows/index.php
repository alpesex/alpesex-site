...
try {
    ...
    $file = getenv('ALPESEX_WINDOWS_INSTALLER') ?: '/home/www/private/downloads/CPMP-ASM-Setup-5.4.19-x64.exe';
    ...
    header('Content-Disposition: attachment; filename="CPMP-ASM-Setup-5.4.19-x64.exe"');
