...
document.querySelector('#invited-form')?.addEventListener('submit',event=>{
  ...
  delete data.passwordConfirmation;data.invitedByManager=true;data.invitationToken=invitationToken||'';
