...
Adresse canonique : `https://alpes-ex.fr/application/`.
...
- Windows / macOS : ouvrir l'adresse dans Chrome ou Edge et choisir **Installer**.
...
- `/application/`, `/application/index.html`, les scripts, styles et icônes de la
  liste `SHELL` accessibles publiquement. Les API restent protégées par session.
